...
export const projectsConfig = {
  ...
  projects: [
    {
      title: "Smart irrrigation system",
      description:
        "Improved Ul responsiveness across device",
      technologies: ["Html", "CSS", "javascript", "arduino"],
      
    },
    {
      title: "HimalayaEscape - Tour & Travel Website",
      description:
